...
import { findUserById, publicUser } from "./index";
...
// ---- instructor portfolio / profile ----
// Updates the editable profile columns on the instructor's users row.
// Only the allowed fields that are not `undefined` are written; the updated
// public user (password stripped) is returned. The user id is the users.id.
...
export async function updateInstructorProfile(userId, fields) {
